...
from torch_fl.backends.bpu.calibrate import Calibration, TensorRange, calibrate_module  # noqa: E402
from torch_fl.backends.bpu.qdq import quantize_onnx  # noqa: E402
...
def test_calibrate_onnx_scales_the_conv_inputs(tmp_path):
    ...
    from torch_fl.backends.bpu.calibrate import calibrate_onnx
